 ...
 *
 */
public class Float2ShortConverter extends AbstractNumberConverter<Float, Short> {

    
    public Float2ShortConverter() {
	super();
    }
    
    public Float2ShortConverter(String format) {
	super();
    }

    @Override
    public Short convert(Float source) {
