 ...
 *
 */
public class BigDecimal2ShortConverter extends AbstractNumberConverter<BigDecimal, Short> {

    
    public BigDecimal2ShortConverter() {
	super();
    }
    
    public BigDecimal2ShortConverter(String format) {
	super();
    }
