 ...
 *
 */
public class Float2LongConverter extends AbstractNumberConverter<Float, Long> {

    
    public Float2LongConverter() {
	super();
    }
    
    public Float2LongConverter(String format) {
	super();
    }

    @Override
    public Long convert(Float source) {
