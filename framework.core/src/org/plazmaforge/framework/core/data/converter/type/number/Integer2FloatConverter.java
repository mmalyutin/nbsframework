 ...
 *
 */
public class Integer2FloatConverter extends AbstractNumberConverter<Integer, Float> {

    
    public Integer2FloatConverter() {
	super();
    }
    
    public Integer2FloatConverter(String format) {
	super();
    }
