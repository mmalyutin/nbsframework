 ...
 *
 */
public class Short2IntegerConverter extends AbstractNumberConverter<Short, Integer> {

    
    public Short2IntegerConverter() {
	super();
    }
    
    public Short2IntegerConverter(String format) {
	super();
    }
