 ...
 *
 */
public class ComboBoxGenerator extends AbstractViewerFieldGenerator {
	...
	generateSetStringProperty(context, data, bean, ComboBox.PROPERTY_DISPLAY_PROPERTY, sw);
	generateSetIntegerProperty(context, data, bean, ComboBox.PROPERTY_SELECTION_INDEX, sw);
    }
