 ...
 *
 */
public class MenuItemGenerator extends AbstractItemGenerator {
	...
	return baseType == null ? null : UIGenerator.UWT_WIDGET_PACKAGE + ".menu." + baseType;
    }
	...
	generateSetStringProperty(context, data, bean, MenuItem.PROPERTY_COMMAND, sw);
    }
