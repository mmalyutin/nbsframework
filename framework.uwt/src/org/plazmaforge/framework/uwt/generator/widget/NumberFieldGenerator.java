...
public class NumberFieldGenerator extends AbstractFieldGenerator {

    @Override
    public boolean accept(String type) {
	return eq(type, UIBuilder.NUMBER_FIELD_TYPE);
    }    
	...
	generateSetFloatProperty(context, data, bean, NumberField.PROPERTY_VALUE, sw); // TODO: May be use Number type
    }
    
    protected void generateSetFormat(ScopeContext context, IData data, String bean, SourceWriter sw) {
	generateSetStringProperty(context, data, bean, NumberField.PROPERTY_FORMAT, sw);
    }
}
