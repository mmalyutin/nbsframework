 ...
 *
 */
public abstract class AbstractFieldGenerator extends ControlGenerator {

    
    protected abstract void generateSetValue(ScopeContext context, IData data, String bean, SourceWriter sw);
	...
	generateSetStringProperty(context, data, bean, Widget.PROPERTY_PROPERTY, sw);
	generateSetStringProperty(context, data, bean, Widget.PROPERTY_DATA_TYPE, sw);
	
	generateSetValue(context, data, bean, sw);
