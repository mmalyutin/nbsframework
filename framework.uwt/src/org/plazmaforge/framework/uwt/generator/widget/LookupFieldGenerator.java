 ...
 *
 */
public class LookupFieldGenerator extends AbstractViewerFieldGenerator {
	...
	generateSetStringProperty(context, data, bean, LookupField.PROPERTY_DISPLAY_PROPERTY, sw);
	generateSetIntegerProperty(context, data, bean, LookupField.PROPERTY_SELECTION_INDEX, sw);
    }
