 ...
 *
 */
public class ListBoxGenerator extends AbstractViewerFieldGenerator {
	...
	generateSetIntegerProperty(context, data, bean, ListBox.PROPERTY_DISPLAY_PROPERTY, sw);
	generateSetIntegerProperty(context, data, bean, ListBox.PROPERTY_SELECTION_INDEX, sw);
    }
