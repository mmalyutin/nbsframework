 ...
 *
 */
public class TimeFieldGenerator extends AbstractFieldGenerator {
	...
	generateSetTimeProperty(context, data, bean, TimeField.PROPERTY_VALUE, sw);
    }
    
    protected void generateSetFormat(ScopeContext context, IData data, String bean, SourceWriter sw) {
	generateSetStringProperty(context, data, bean, TimeField.PROPERTY_FORMAT, sw);
    }
