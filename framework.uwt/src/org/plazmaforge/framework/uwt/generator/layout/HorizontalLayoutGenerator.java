...
public class HorizontalLayoutGenerator extends BoxLayoutGenerator {

    @Override
    public boolean accept(String type) {
	return type == null ? false: (UIBuilder.HORIZONTAL_LAYOUT_TYPE.equals(type) || "HorizontalLayout".equals(type));
    }
