...
import org.plazmaforge.framework.uwt.swing.widget.IXField;

public class SwingCellEditor extends AbstractCellEditor implements TableCellEditor, TreeCellEditor {
     ...
     */
//    public SwingCellEditor(final JTextField textField) {
...
//    }
     ...
     */
    public SwingCellEditor(final JCheckBox checkBox) {
     ...
     */
    public SwingCellEditor(final JComboBox comboBox) {
	...
	delegate = new EditorDelegate() {
		...
		if (comboBox.isEditable()) {
		    // Commit edited value.
		    comboBox.actionPerformed(new ActionEvent(SwingCellEditor.this, 0, ""));
		}
    ...
    public SwingCellEditor(final IXField textField) {
	editorComponent = (JComponent) textField;
	this.clickCountToStart = 2;
	delegate = new EditorDelegate() {
	    public void setValue(Object value) {
