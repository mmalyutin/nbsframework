...
public class SwingListCellRenderer extends DefaultListCellRenderer {

    private ListBox listBox;
    
    
    public SwingListCellRenderer(ListBox listBox) {
	super();
	...
	Object value = UWTUtils.getSimpleValue(arg1, listBox.getDisplayProperty(), listBox.getPropertyProvider(), listBox);
