...
//FIXED: [ohapon] JdbcDaoImpl

public class PlatformJdbcDaoImpl extends JdbcDaoSupport implements UserDetailsService {
    ...
    protected List<UserDetails> loadUsersByUsername(String username) {
        return getJdbcTemplate().query(usersByUsernameQuery, new String[] {username}, new RowMapper<UserDetails>() {
            public UserDetails mapRow(ResultSet rs, int rowNum) throws SQLException {
                ...
                boolean enabled = getBooleanValue(rs.getString(3)); // FIXED ohapon
    ...
    private boolean getBooleanValue(String str) {
        ...
        if ( "1".equals(str) || "Y".equals(str) || "YES".equals(str) || "T".equals(str) || "TRUE".equals(str) ) {
            return true;
        }
        return false;
    }
