 ...
 *
 */
public class BigDecimal2IntegerConverter extends AbstractNumberConverter<BigDecimal, Integer> {

    
    public BigDecimal2IntegerConverter() {
	super();
    }
    
    public BigDecimal2IntegerConverter(String format) {
	super();
    }
