 ...
 *
 */
public class BigDecimal2LongConverter extends AbstractNumberConverter<BigDecimal, Long> {

    
    public BigDecimal2LongConverter() {
	super();
    }
    
    public BigDecimal2LongConverter(String format) {
	super();
    }
