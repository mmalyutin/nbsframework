 ...
 *
 */
public class BigInteger2LongConverter extends AbstractNumberConverter<BigInteger, Long> {

    
    public BigInteger2LongConverter() {
	super();
    }
    
    public BigInteger2LongConverter(String format) {
	super();
    }
