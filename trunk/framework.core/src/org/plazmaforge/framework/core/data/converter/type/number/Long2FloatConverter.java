 ...
 *
 */
public class Long2FloatConverter extends AbstractNumberConverter<Long, Float> {

    
    public Long2FloatConverter() {
	super();
    }
    
    public Long2FloatConverter(String format) {
	super();
    }

    @Override
    public Float convert(Long source) {
