 ...
 *
 */
public class BigDecimal2FloatConverter extends AbstractNumberConverter<BigDecimal, Float> {

    
    public BigDecimal2FloatConverter() {
	super();
    }
    
    public BigDecimal2FloatConverter(String format) {
	super();
    }
