 ...
 *
 */
public class Short2FloatConverter extends AbstractNumberConverter<Short, Float> {

    
    public Short2FloatConverter() {
	super();
    }
    
    public Short2FloatConverter(String format) {
	super();
    }

    @Override
    public Float convert(Short source) {
