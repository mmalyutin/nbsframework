 ...
 *
 */
public class BigInteger2IntegerConverter extends AbstractNumberConverter<BigInteger, Integer> {

    
    public BigInteger2IntegerConverter() {
	super();
    }
    
    public BigInteger2IntegerConverter(String format) {
	super();
    }
