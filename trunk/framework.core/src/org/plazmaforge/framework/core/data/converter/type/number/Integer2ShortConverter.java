 ...
 *
 */
public class Integer2ShortConverter extends AbstractNumberConverter<Integer, Short> {

    
    public Integer2ShortConverter() {
	super();
    }
    
    public Integer2ShortConverter(String format) {
	super();
    }
