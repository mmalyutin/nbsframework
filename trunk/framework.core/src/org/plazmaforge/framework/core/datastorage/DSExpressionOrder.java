 ...
 *
 */
public class DSExpressionOrder extends DSOrder implements HasExpression  {

    private static final long serialVersionUID = -6306923244592281918L;
    
    private DSExpression expression;

    public DSExpressionOrder() {
	super();
    }

    public DSExpressionOrder(DSExpression expression) {
	super();
	...
	if (getClass() != obj.getClass())
	    return false;
	DSExpressionOrder other = (DSExpressionOrder) obj;
	if (expression == null) {
