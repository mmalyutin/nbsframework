...
public abstract class AbstractLayoutGenerator extends AbstractGenerator implements IUIGenerator {
    ...
    protected String getDefaultLayoutClassName(String baseType, String type) {
	if (type == null) {
