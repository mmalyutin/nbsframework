 ...
 *
 */
public class ImageBoxGenerator extends ControlGenerator implements IUIGenerator {
	...
	generateSetRSStringProperty(context, data, bean, ImageBox.PROPERTY_IMAGE, sw); // image attribute as image path
    }
