...
import org.plazmaforge.framework.uwt.widget.QuantityField;

public class QuantityFieldBuilder extends NumberFieldBuilder {

    @Override
    public boolean accept(String type) {
	return eq(type, UIBuilder.QUANTITY_FIELD_TYPE);
    }    
