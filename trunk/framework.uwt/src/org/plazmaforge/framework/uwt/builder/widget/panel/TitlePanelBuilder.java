 ...
 *
 */
public class TitlePanelBuilder extends PanelBuilder {

    @Override
    public boolean accept(String type) {
	return eq(type, UIBuilder.TITLE_PANEL_TYPE);
    }
	...
	TitlePanel panel = (TitlePanel) element;
	
	// Title of panel
	String title = getString(data, TitlePanel.PROPERTY_TITLE);
	if (title != null) {
