 ...
 */
public class Padding extends Insets {
	...
	if (obj instanceof Padding) {
	    ...
	    return equals(padding.getTop(), padding.getRight(), padding.getBottom(), padding.getLeft());
	}
	return super.equals(obj);
    }
    
    public Padding clone() {
	return new Padding(getTop(), getRight(), getBottom(), getLeft());
    }
