 ...
 *
 */
public class RepotToolProductXLS_IN_Test extends AbstractTestCase {
	...
	String reportFile = getResourcesFileName("reports/ProductXLS.report.xml");
	String outputFile = getTestFileName("ProductXLS_IN.pdf");
