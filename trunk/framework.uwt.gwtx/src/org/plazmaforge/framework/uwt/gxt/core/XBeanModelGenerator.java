...
//import com.sencha.gxt.ui.client.data.BeanModelFactory;
//import com.sencha.gxt.ui.client.data.BeanModelLookup;
//import com.sencha.gxt.ui.client.data.BeanModelMarker;
//import com.sencha.gxt.ui.client.data.BeanModelTag;
...
public class XBeanModelGenerator extends Generator {
    ...
    /**
     * Return marker class (interface) Override to use other marker
     * 
     * @return
     */
    ...
    /**
     * Return GXT ModelData class Override to use other class
     * 
     * @return
     */
	...
	beanPackages = new String[] { "org.plazmaforge.framework.config.object",
		"org.plazmaforge.bs.base.shared.entities", "org.plazmaforge.bs.organization.shared.entities",
		"org.plazmaforge.bs.partner.shared.entities", "org.plazmaforge.bs.contact.shared.entities",
		"org.plazmaforge.bs.document.shared.entities", "org.plazmaforge.bs.project.shared.entities" };
	beanClasses = new String[] { "org.plazmaforge.framework.config.object.ObjectConfig", "java.io.Serializable" };
	...
	// oha-remove
	// beanModelMarkerType =
	// oracle.findType(BeanModelMarker.class.getName());
	...
	try {
		...
		// oha-remove
		/*
		 * if (isBeanMarker(type)) { beans.add(getMarkerBean(type)); }
		 * else if (isBean(type)) { beans.add(type); }
		 */
	    }
		...
		for (int i = 0; i < beans.size(); i++) {
		    ...
		    sb.append(
			    "  m.put(" + bean.getQualifiedSourceName() + ".class.getName(), new " + factory + "());\n");
		    sb.append("}\n");
    ...
    */
    ...
    // oha-remove
    /*
     * protected boolean isBean(JClassType type) { return
     * !type.equals(beanModelTagType) && type.isAssignableTo(beanModelTagType)
	...
	// return !type.equals(beanMarkerType) &&
	// type.isAssignableTo(beanMarkerType)
	...
	for (JMethod method : getters) {
		...
		if (returnType != null && returnType.isAssignableTo(oracle.getType(List.class.getName()))
			...
			sw.println("java.util.List list2 = " + XBeanModelLookup.class.getCanonicalName()
			...
			sw.println("    }");
			sw.println("    if (nestedModel == null) {");
			sw.println("        nestedModel = " + XBeanModelLookup.class.getCanonicalName()
