...
public class DateFormatter extends DateTimeFormatter {
     ...
     * both the date part for the given locale. The corresponding pattern string
     ...
     * overrides the parent method, restricting autorized chars to date
     * patterns.
     * 
     * @param c
     *            pattern char
     ...
     *             if not valid
     * @see org.plazmaforge.framework.uwt.swt.widget.DateTimeFormatter#isValidCharPattern(char)
     */
    @Override
