...
import org.plazmaforge.framework.uwt.jfx.widget.XCanvas;
 ...
 *
 */
public class JFXCanvasAdapter extends JFXControlAdapter {
	...
	XCanvas xCanvas = new XCanvas() {
	    ...
	    protected void paint(GraphicsContext context2d) {
    ...
    protected void initContext2d(GraphicsContext context2d, GC gc) {
	if (context2d == null) {
	    return;
	}
