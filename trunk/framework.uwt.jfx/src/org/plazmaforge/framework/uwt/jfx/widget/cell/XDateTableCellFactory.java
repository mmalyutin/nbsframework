 ...
 * @param <S>
 */
public class XDateTableCellFactory<S> extends XAbstractTableCellFactory<S, Date> {

    private DateFormat formatter;
    
    public XDateTableCellFactory() {
	super();
	//TODO
	initFormatter("yyyy-MM-dd");
    }
    
    public XDateTableCellFactory(DateFormat formatter) {
	super();
	this.formatter = formatter;
    }

    public XDateTableCellFactory(String format) {
	super();
