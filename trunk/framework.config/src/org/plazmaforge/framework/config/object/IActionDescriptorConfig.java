 ...
 *
 */
public interface IActionDescriptorConfig extends IElement {

    /**
     * Return action ref (name)
     * @return
     */
    String getRef();
    ...
    void setControlPosition(String controlPosition);

    String getControlRelative();

    void setControlRelative(String controlRelative);
