 ...
 *
 */
public class RepotToolProductJSON_IN_Test extends AbstractTestCase {
	...
	String reportFile = getResourcesFileName("reports/ProductJSON.report.xml");
	String outputFile = getTestFileName("ProductJSON_IN.pdf");
