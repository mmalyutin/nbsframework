 ...
 *
 */
public class RepotToolProductSQL_IN_Test extends AbstractTestCase {
	...
	String reportFile = getResourcesFileName("reports/ProductSQL.report.xml");
	String outputFile = getTestFileName("ProductSQL_IN.pdf");
