 ...
 *
 */
public class RepotToolProductXLSX_IN_Test extends AbstractTestCase {
	...
	String reportFile = getResourcesFileName("reports/ProductXLSX.report.xml");
	String outputFile = getTestFileName("ProductXLSX_IN.pdf");
