 ...
 *
 */
public class XLayoutContainer extends AnchorPane {
	...
	// Resize container (fill)
	AnchorPane.setLeftAnchor(container, 1.0);
	AnchorPane.setRightAnchor(container, 1.0);
	AnchorPane.setTopAnchor(container, 1.0);
	AnchorPane.setBottomAnchor(container, 1.0);
    }
